...
export default function ExperienceCard({
  ...
  return (
    <div
      key={id}
      className="bg-white border-4 border-black rounded-xs shadow-[11.465px_11.465px_0px_0px_#bfbfb4] hover:z-20 hover:scale-105 transition-all duration-300 ease-in-out"
