...
export default function ExperienceCard({
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex flex-col md:gap-8 gap-4 p-4 md:p-10">
          <p className="font-medium text-lg md:text-2xl text-primary">{date}</p>
          <div className="flex flex-col gap-2 md:gap-2.5">
            <h3 className="font-semibold text-lg md:text-2xl text-primary">
              {title}
            </h3>
            <ul className="font-medium text-sm md:text-xl text-muted list-disc pl-4 md:ml-6">
